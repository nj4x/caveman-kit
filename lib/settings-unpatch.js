#!/usr/bin/env node
// caveman-kit — surgically removes the SessionStart, SubagentStart, and UserPromptSubmit hook
...
const ACTIVATE_MARKER = 'caveman-activate.js';
const TRACKER_MARKER = 'caveman-mode-tracker.js';
